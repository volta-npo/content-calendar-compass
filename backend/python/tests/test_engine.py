...
from content_calendar_compass_backend.engine import DOMAIN_ROWS, PRODUCT_SLUG, build_release_packet, summarize_rows
...
class ServerModuleTests(unittest.TestCase):
    def test_health_handler_exists(self):
        from content_calendar_compass_backend.server import Handler
