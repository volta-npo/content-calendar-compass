...
# 📣 Content Calendar Compass

### A local-business content calendar that starts from real events, inventory, seasons, and community moments.
...
**Marketing & Content** · **Repo 21/50** · **No backend. No login. Client data stays local.**

[Live app](https://volta-npo.github.io/21-content-calendar-compass/) · [Report an issue](https://github.com/volta-npo/21-content-calendar-compass/issues) · [Volta](https://voltanpo.org)
...
**Content Calendar Compass** is a polished, local-first open-source tool from Volta's 50-project OSS division. It helps Marketing students managing social accounts turn real community work into structured evidence, client-safe handoffs, and mentor-reviewable release packets.
...
Generic content calendars produce generic posts. Local businesses need community-grounded planning.

### The niche

Hyperlocal organic marketing for small businesses.

### North-star metric

`posts tied to real local moments`
...
flowchart TD
    ...
    Evidence --> Workbench["Content Calendar Compass"]
    Workbench --> Score["Content readiness"]
    Score --> Cert["v3 production certification"]
    Cert --> A1["30-day calendar"]
    Cert --> A2["Post briefs"]
    Cert --> A3["CSV posting plan"]
...
flowchart LR
    subgraph Modules["First-class modules"]
        M1["Community event prompts"]
        M2["Seasonal campaign board"]
        M3["Owner voice notes"]
        M4["Publishing checklist"]
    end
    M1 --> Workbench
    M2 --> Workbench
    M3 --> Workbench
...
sequenceDiagram
    ...
    participant T as Content Calendar Compass
...
|---|---|
| **Domain workbench** | A purpose-built content calendar interface for a local-business content calendar that starts from real events, inventory, seasons, and community moments. |
...
|---:|---|---|
| 1 | **Community event prompts** | Converts field work into repeatable, reviewable Volta delivery evidence. |
| 2 | **Seasonal campaign board** | Converts field work into repeatable, reviewable Volta delivery evidence. |
| 3 | **Owner voice notes** | Converts field work into repeatable, reviewable Volta delivery evidence. |
| 4 | **Publishing checklist** | Converts field work into repeatable, reviewable Volta delivery evidence. |
...
```bash
git clone https://github.com/volta-npo/21-content-calendar-compass.git
cd 21-content-calendar-compass
npm test
npm start
```
