export const v3 = {
    "productName": "Content Calendar Compass",
    "productTier": "release",
    ...
    "capabilities": [
        "Domain-specific workbench: Hyperlocal Content Calendar",
        "Operational table: Content plan",
    ...
    "releaseChecklist": [
        ...
        "Localness Score reaches production threshold",
        "Approval Coverage is documented with evidence",
        "Cadence Health has no unresolved blocker",
        "30-day calendar verified",
        "Post briefs verified",
        "CSV posting plan verified"
    ],
    "operations": [
